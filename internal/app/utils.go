...
func ensureFormat(format, fileName string) string {
	return bookutil.EnsureFormat(format, fileName)
}

func determineFormatFromFileName(fileName string) string {
	return bookutil.DetermineFormatFromFileName(fileName)
}

func sanitizeFilename(name string) string {
	return bookutil.SanitizeFilename(name)
}

func mimeForFormat(format string) string {
	return bookutil.MimeForFormat(format)
}
