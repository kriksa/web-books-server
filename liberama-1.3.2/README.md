...
```js
{
    ...
    // Парамертр root указывает путь для корневой страницы читалки
    // например для "root": "/read", веб-интерфейс будет доступен по адресу http://127.0.0.1:44080/read
    // root необходим при настройке reverse-proxy и встраивании liberama в уже существующий сервер
    "root": "",
