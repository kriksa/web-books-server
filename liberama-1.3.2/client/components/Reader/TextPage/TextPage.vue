<template>
    <div ref="main" class="main">
        ...
        <div v-show="showStatusBar" ref="statusBar" class="layout" :class="{'no-events': $root.isMobileDevice}">
            <div v-html="statusBar"></div>
        </div>
        <div
            v-show="$root.isMobileDevice" ref="layoutEvents" class="layout events"
...
class TextPage {
    ...
    calcDrawProps() {
        ...
        page1.pointerEvents = page2.pointerEvents = (this.$root.isMobileDevice ? 'none' : 'auto');
